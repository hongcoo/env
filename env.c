...
PHP_MINIT_FUNCTION (env)
{
    ...
    REGISTER_STRINGL_CONSTANT("ENV_VERSION", PHP_ENV_VERSION, sizeof(PHP_ENV_VERSION) - 1, CONST_PERSISTENT | CONST_CS);
    REGISTER_STRINGL_CONSTANT("ENV_ENVIRON", ENV_G(name), strlen(ENV_G(name)), CONST_PERSISTENT | CONST_CS);
